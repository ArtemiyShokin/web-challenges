...
console.log(bookTitle, bookAuthor, bookRating, bookSales);
...
logBookData("The Art of Code", "Belka", 10, 100);
logBookData("The Art of Code", "Belka", 10, 200);
logBookData("The Art of Code", "Belka", 10, 500);
