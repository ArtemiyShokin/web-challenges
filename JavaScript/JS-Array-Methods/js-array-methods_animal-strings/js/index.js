...
const everyAnimalHasMoreThanTwoLetters = animalStrings.filter((animal) => {
...
const concatenateAnimals = animalStrings.reduce((a, b) => a + b);
const sumOfAllAnimalCharacters = concatenateAnimals.length;
