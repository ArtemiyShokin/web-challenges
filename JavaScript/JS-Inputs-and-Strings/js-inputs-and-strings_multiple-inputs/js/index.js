...
switchValueButton.addEventListener("click", () => {
  const switchedFirstValue = secondSwitchValueInput.value;
  const switchedSecondValue = firstSwitchValueInput.value;
  firstSwitchValueInput.value = switchedFirstValue;
  secondSwitchValueInput.value = switchedSecondValue;
});
// --^-- End of Task 3 --^--
