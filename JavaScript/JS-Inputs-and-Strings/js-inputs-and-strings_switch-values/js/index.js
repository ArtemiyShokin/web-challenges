...
switchButton.addEventListener("click", () => {
  const switchedFirstInput = secondInput.value;
  const switchedSecondInput = firstInput.value;
  firstInput.value = switchedFirstInput;
  secondInput.value = switchedSecondInput;
});
